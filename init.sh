...
mkdir -p $ADHOC_HOME/odoo/data/postgres
mkdir -p $ADHOC_HOME/odoo/data/odoo/
chown -R 100:100 $ADHOC_HOME/odoo/data/odoo
...
wget -qO- https://raw.githubusercontent.com/adhoc-dev/vm-external-odoo/refs/heads/main/V$ODOO_VERSION/docker-compose.yaml > $ADHOC_HOME/odoo/docker-compose.yaml

wget -qO- https://raw.githubusercontent.com/adhoc-dev/vm-external-odoo/refs/heads/main/V$ODOO_VERSION/nginx.conf > $ADHOC_HOME/odoo/odoo/vhost.d/$CLIENT_DOMAIN

wget -qO- https://raw.githubusercontent.com/adhoc-dev/vm-external-odoo/refs/heads/main/V$ODOO_VERSION/odoo.conf > $ADHOC_HOME/odoo/odoo/config/odoo.conf
...
wget -qO- https://raw.githubusercontent.com/adhoc-dev/vm-external-odoo/refs/heads/main/V$ODOO_VERSION/gitaggregate.yaml > $ADHOC_HOME/odoo/gitaggregate.yaml
...
chown -R 26:102 $ADHOC_HOME/odoo/data/postgres
chown -R 100:100 $ADHOC_HOME/odoo/data/odoo
